...
@section('content')
    ...
    <div class="table" data-name="tablaInscriptos">
        ...
        <div class="perfil__header-alt">
            <a href="{{ route('admin.inscriptos.create') }}"><button class="btn_blue"><i class="ti ti-circle-plus"
                        ...
                        <td class="flex just-center">
                            <div style="display: flex; justify-content: center;">
                                ...
                                @if (!$config['modo_seguro'])
                                    <form method="POST" id="form-eliminar-{{ $inscripcion->id }}"
                                        action="{{ route('admin.inscriptos.destroy', $inscripcion->id) }}"
                                        class="form-eliminar" style="margin-left: 10px;">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
