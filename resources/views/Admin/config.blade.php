            ...
            <div class="perfil__info config">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <input class="campo_info" name="correo1" value="{{ old('correo1', $configuracion['correo1'] ?? '') }}">
                        <input class="campo_info" name="correo2" value="{{ old('correo2', $configuracion['correo2'] ?? '') }}">
                        <input class="campo_info" name="correo3" value="{{ old('correo3', $configuracion['correo3'] ?? '') }}">
                    </div>

                    <div class="form-group">
                        <label>Números telefónicos</label>
                        <input class="campo_info" name="telefono1" value="{{ old('telefono1', $configuracion['telefono1'] ?? '') }}">
                        <input class="campo_info" name="telefono2" value="{{ old('telefono2', $configuracion['telefono2'] ?? '') }}">
                        <input class="campo_info" name="telefono3" value="{{ old('telefono3', $configuracion['telefono3'] ?? '') }}">
                    </div>

                    <div class="form-group">
                        <label>Más información</label>
                        <input class="campo_info" name="mas_info1" value="{{ old('mas_info1', $configuracion['mas_info1'] ?? '') }}">
                        <input class="campo_info" name="mas_info2" value="{{ old('mas_info2', $configuracion['mas_info2'] ?? '') }}">
                        <input class="campo_info" name="mas_info3" value="{{ old('mas_info3', $configuracion['mas_info3'] ?? '') }}">
                    </div>
                </fieldset>
            </div>
        </div>
            ...
            <div class="perfil__info config">
                <fieldset>
                    ...
                    <div class="form-group switches">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="alumno_puede_anotarse_mesa" value="1" @checked($config['alumno_puede_anotarse_mesa'])>
                    ...
                    <div class="form-group switches">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="alumno_puede_bajarse_mesa" value="1" @checked($config['alumno_puede_bajarse_mesa'])>
                            <span class="sliderr round"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group switches">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="alumno_puede_anotarse_cursada" value="1" @checked($config['alumno_puede_anotarse_cursada'])>
                            <span class="sliderr round"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group switches">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="alumno_puede_bajarse_cursada" value="1" @checked($config['alumno_puede_bajarse_cursada'])>
                            <span class="sliderr round"></span>
                        </label>
                    </div>
                    ...
                    <div class="form-group switches">
                        ...
                        <label class="switch">
                            <input type="checkbox" name="alumno_puede_anotarse_libre" value="1" @checked($config['alumno_puede_anotarse_libre'])>
                            <span class="sliderr round"></span>
                        </label>
                    </div>
