            ...
            <div class="contenedor_mesa">
                ...
                @if ($anterior)
                    <div class="boton-anterior">
                        <button class="btn_icon-danger"
                            style="background-color: #150a5c; color: white; display: flex; align-items: center; padding: 8px 12px;  margin-left: 20px;"
                ...
                @if ($siguiente)
                    <div class="boton-siguiente">
                        ...
                        <button class="btn_icon-danger"
                            style="background-color: #150a5c; color: white; display: flex; align-items: center; padding: 8px 12px; margin-right: 20px;"
