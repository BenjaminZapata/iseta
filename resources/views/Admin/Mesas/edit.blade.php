    ...
    <div class="perfil_one br">
        ...
        <div class="matricular">
            ...
            <form method="POST" action="{{ route('admin.examenes.store') }}">
                ...
                <div class="upd"><button class="btn_blue"><i class="ti ti-upload" style="font-size: 1.3em; margin-right: 8px;"></i>Cargar</button></div>
        ...
        <div class="table__header">
            ...
            <div class="flex just-center">
                <a href="{{ route('admin.mesas.acta', ['mesa' => $mesa->id]) }}" target="_blank">
                    <button class="btn_grey"><i class="ti ti-file-download" style="font-size: 1.3em; margin-right: 8px;"></i>
                        Regular</button>
                </a>
                <a href="{{ route('admin.mesas.actaprom', ['mesa' => $mesa->id]) }}" target="_blank"><button
                        class="btn_grey"><i class="ti ti-file-download" style="font-size: 1.3em; margin-right: 8px;"></i>Promoción</button></a>
                <a href="{{ route('admin.mesas.actalibre', ['mesa' => $mesa->id]) }}" target="_blank"><button
                        class="btn_grey"><i class="ti ti-file-download" style="font-size: 1.3em; margin-right: 8px;"></i>Libre</button></a>
