                                        ...
                                        <tr class="subject-summary">
                                            ...
                                            <td class="flex just-center" style="min-width: 200px">
                                                <div class="centrar" style="gap: 10px">
                                                    <div>
                                                        <button class="btn_blue subject-body"
        ...
        document.addEventListener('click', function(e) {
            ...
            if (careerBtn) {
                ...
                if (target) {
                    ...
                    const icon = careerBtn.querySelector('i');
            ...
            const subjectBtn = e.target.closest('.subject-body');
            if (subjectBtn) {
                ...
                if (target) {
                    target.classList.toggle('hidden');
                    // Cambiar texto dinámicamente
                    const icon = subjectBtn.querySelector('i');
                    if (target.classList.contains('hidden')) {
                        subjectBtn.innerHTML = `<i class="ti ti-users iconos"></i> Ver alumnos`;
                    } else {
                        subjectBtn.innerHTML = `<i class="ti ti-users iconos"></i> Ocultar alumnos`;
                    }
                }
                return;
            }
