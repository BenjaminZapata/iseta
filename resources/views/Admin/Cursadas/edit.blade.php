            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ul class="breadcrumb flex items-center gap-2 text-sm text-gray-700">
                    ...
                    @if ($from === 'alumnos')
                        ...
                        <li><a href="/admin/alumnos/{{ $cursada->alumno->id }}/edit">{{ $cursada->alumno->apellido }}
                                {{ $cursada->alumno->nombre }}</a></li>
                    ...
                    @elseif ($from === 'mesas')
                        ...
                        <li><a href="/admin/mesas/{{ $asignatura = $mesa }}/edit">{{ $cursada->asignatura->nombre }}</a>
                        </li>
                        <li><span class="text-gray-500" style="color: black;"> {{ $cursada->carrera->nombre }}</span></li>
