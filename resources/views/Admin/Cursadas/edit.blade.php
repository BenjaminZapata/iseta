        ...
        <div class="perfil__info">
            ...
            <form method="POST" action="{{ route('admin.cursadas.update', ['cursada' => $cursada->id]) }}">
                ...
                <div class="botones-derecha"
                    ...
                    <a href="{{ route('admin.cursadas.index') }}" style="display: flex; align-items: center;">
            ...
            <div class="boton-eliminar">
                <form class="form-eliminar" method="post"
                    ...
                    @csrf
                    @method('delete')
                    <button class="btn_red_outline" onclick="openGeneralModal('form-eliminar-{{ $cursada->id }}', '¿Estás seguro de que querés eliminar la cursada: {{ strtoupper($cursada->asignatura->nombre) }} del alumno: {{ strtoupper($cursada->alumno->apellido) }} {{ strtoupper($cursada->alumno->nombre) }}? \n \n ESTA ACCIÓN NO SE PUEDE DESHACER.')"
