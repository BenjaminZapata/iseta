    ...
    <div class="edit-form-container">
        <div class="perfil_one br">
            ...
            <div class="perfil__info">
                ...
                <form method="POST" action="{{route('Regente.cursadas.update', ['cursada' => $cursada->id])}}">
                    @csrf
                    @method('put')
                    ...
                    <div class="botones-derecha"
                        ...
                        <a href="{{route('regente.cursadas.index')}}" style="display: flex; align-items: center;">
        ...
        @if (!$config['modo_seguro'])
            <div class="upd">
                <form class="form-eliminar" method="post"
                    action="{{route('Regente.cursadas.destroy', ['cursada' => $cursada->id])}}">
                    @csrf
                    @method('delete')
