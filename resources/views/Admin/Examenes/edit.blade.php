    ...
    <div class="perfil_one br">
        ...
        <nav aria-label="breadcrumb" class="mb-4">
            <ul class="breadcrumb flex items-center gap-2 text-sm text-gray-700">
                ...
                <li>
                    <a href="/admin/mesas/{{ $examen->mesa->id }}/edit">{{ $examen->asignatura->nombre }}</a>
                </li>
                <li>
                    <a href="/admin/examenes/{{ $examen->alumno->id }}/edit">{{ $examen->alumno->apellido }} {{ $examen->alumno->nombre }}</a>
                </li>
            </ul>
        </nav>
