    ...
    <div class="perfil_one br">
        ...
        <div class="perfil_one br">
            ...
            <div class="matricular">
                <form action="{{ route('Regente.alumno.rematricular', ['alumno' => $alumno->id]) }}">
                    <select name="carrera">
                ...
                <a href="{{ route('Regente.inscriptos.create', ['alumno_id' => $alumno->id]) }}"
                        ...
                        @endif
                                ...
                                <tr data-name="MateriaCursada">
                                    ...
                                    <td class="flex just-center">
                                        <a href="{{ route('Regente.cursadas.edit', ['cursada' => $cursada->id]) }}">
                    ...
                    @foreach ($examenes as $examen)
                        ...
                        @endif
                                ...
                                <tr>
                                    ...
                                    <td class="flex just-center">
                                        <a href="{{ route('Regente.examenes.edit', ['examen' => $examen->id]) }}">
                                            <button class="btn_blue"><i class="ti ti-edit"
                                                    style="font-size: 1.3em; margin-right: 8px;"></i>Editar</button>
                                        </a>
                                    </td>
