...
<div class="edit-form-container">
    <div class="table">
        ...
        <div class="accordion" id="cursadasAccordion">
            @php
                $agrupadas = collect($cursadas)->groupBy(fn($c) => $c->carrera);
                $carrera_index = 0;
            @endphp

            @foreach ($agrupadas as $carrera => $porCarrera)
                @php
                    $carrera_index++;
                    $porAnio = $porCarrera->groupBy('anio_asig');
                    $anio_index = 0;
                @endphp
                    ...
                    <div id="collapseCarrera{{ $carrera_index }}" class="accordion-collapse collapse"
                        ...
                        <div class="accordion-body p-2">
                            <div class="accordion" id="anioAccordion{{ $carrera_index }}">
                                @foreach ($porAnio as $anio => $asignaturas)
                                    @php
                                        $anio_index++;
                                        $anio = (int) $anio;
                                    @endphp
                                            ...
                                            <div class="accordion-body p-0">
                                                <table class="table table-bordered table-hover mb-0 text-center align-middle">
                                                    ...
                                                    <tbody class="table__body">
                                                        @foreach ($asignaturas as $cursada)
    ...
    <div class="table__header">
        <h2>Exámenes</h2>
        <p>Importante: algunos exámenes de alumnos más antiguos podrían no tener datos sobre las mesas.</p>
    </div>

    <div class="accordion" id="examenesAccordion">
        @php
            $agrupados = collect($examenes)->groupBy(fn($e) => $e->carrera);
            $carrera_index = 0;
        @endphp

        @foreach ($agrupados as $carrera => $porCarrera)
            @php
                $carrera_index++;
                $porAnio = $porCarrera->groupBy('anio_asig');
                $anio_index = 0;
            ...
            <div class="accordion-item">
                ...
                <div id="collapseExamenCarrera{{ $carrera_index }}" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body p-2">
                        <div class="accordion" id="anioExamenAccordion{{ $carrera_index }}">
                            @foreach ($porAnio as $anio => $examenesDelAnio)
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseExamenAnio{{ $carrera_index }}-{{ $anio_index }}" class="accordion-collapse collapse"
                                        ...
                                        data-bs-parent="#anioExamenAccordion{{ $carrera_index }}">
                                        <div class="accordion-body p-0">
                                            <table class="table table-bordered table-hover mb-0 text-center align-middle">
                                                <thead>
                                                    <tr>
