        ...
        <div class="perfil_one br">
            ...
            <nav aria-label="breadcrumb" class="mb-4">
                <ul class="breadcrumb flex items-center gap-2 text-sm text-gray-700">
                    ...
                    <li>
                        <span class="text-gray-500" style="color: black;"> {{ $carrera->nombre }}</span>
                    </li>
                </ul>
            </nav>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="display: flex; align-items: center; justify-content: center;">
                                <a href="{{ route('admin.asignaturas.edit', ['asignatura' => $asignatura->id, 'from' => 'carreras']) }}"
                                    class="btn_blue" style="display: flex; align-items: center;">
