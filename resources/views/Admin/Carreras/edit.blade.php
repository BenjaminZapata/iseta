...
<link rel="stylesheet" href="{{ asset('css/Admin/Carreras/edit-carrera.css') }}">
    ...
    <div class="perfil_one br">
        ...
        <div class="perfil__info">
            <form method="POST" action="{{ route('admin.carreras.update', ['carrera' => $carrera->id]) }}"
                ...
                @method('PUT')
                @csrf
                <fieldset class="p-2 m-[10px]">
                    <legend class="font-600 font-7">Información</legend>
                    <div class="grid-2-fija p-0">
                        <div class="perfil_dataname block w-full">
                            <span class="block bold mb-1">Nombre:</span>
                            <p class="rounded bg-gray-100 p-2">
                                {{ $carrera->nombre }}
                            </p>
                        </div>
                        ...
                        <label class="label-input-y-75">
                            <span class="block bold mb-1">Estado:</span>
                        ...
                        <label class="label-input-y-75">
                            <span class="block bold mb-1">Año de cierre:</span>
                            <input type="text" placeholder='Ej: 2028 (si aplica)' name="anio_fin"
                                value="{{ $carrera->anio_fin }}">
                        </label>

                        <label class="label-input-y-75">
                            <span class="block bold mb-1">Observaciones:</span>
