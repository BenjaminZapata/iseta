...
@section('content')
    ...
    <div class="table" data-name="tablaProfesores">
        ...
        <div class="perfil__header-alt">
            <a href="{{route('Regente.profesores.create')}}">
                <button class="btn_blue">
                    <i class="ti ti-circle-plus"></i>Agregar profesor
                </button>
            </a>
            {{-- FILTROS --}}
            <?= $filtergen->generate('Regente.profesores.index', $filters, [
        // 'dropdowns' => [
                ...
                @foreach ($profesores as $profesor)
                    <tr>
                        ...
                        <td class="flex just-center"><a
                                href="{{route('Regente.profesores.edit', ['profesor' => $profesor->id])}}"><button
