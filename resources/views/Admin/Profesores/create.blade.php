        ...
        <div class="perfil_one br">
            ...
            <div class="perfil__info">
                <?= $form->generate(route('admin.profesores.store'), 'post', [
                        'Profesor' => [$form->text('nombre', 'Nombre:', 'label-input-y-75', null),
                            ...
                            $form->select('estado_civil', 'Estado civil:', 'label-input-y-75', null, ['vacio', 'Soltero', 'Casado', 'Divorciado', 'Viudo', 'Conyuge', 'Otro']), $form->text('lugar_nacimiento', 'Lugar de nacimiento:', 'label-input-y-75', null)],
                        ...
                        'Contacto' => [$form->text('email', 'Email:', 'label-input-y-75', null), $form->text('telefono_1', 'Telefono 1:', 'label-input-y-75', null), $form->text('telefono_2', 'Telefono 2:', 'label-input-y-75', null), $form->text('telefono_3', 'Telefono 3:', 'label-input-y-75', null)],
