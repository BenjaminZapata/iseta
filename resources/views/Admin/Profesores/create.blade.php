...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Selecciona todos los labels y spans del formulario
        document.querySelectorAll("label, span").forEach(el => {

            // Recorre los nodos de texto dentro del elemento
            el.childNodes.forEach(node => {
                if (node.nodeType === Node.TEXT_NODE && node.textContent.includes('*')) {

                    // Reemplaza solo los * por un span rojo
                    const html = node.textContent.replace(/\*/g,
                    ...
                    // Inserta el contenido formateado
