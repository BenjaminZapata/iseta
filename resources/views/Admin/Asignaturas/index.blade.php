        ...
        <div class="perfil__header-alt">
            ...
            <?= $filtergen->generate('admin.asignaturas.index', $filters, [
                    'dropdowns' => [
                        ...
                        $form->select('filter_asignatura_id', 'Asignatura:', 'label-input-y-100', $filters, $asignaturasList->pluck('nombre', 'id')->prepend('Todas', 0)->toArray()),
                ...
                @foreach ($asignaturas as $asignatura)
                    <tr>
                        ...
                        <td class="flex just-center">
                            <a
                                href="{{ route('admin.asignaturas.edit', ['asignatura' => $asignatura->id, 'from' => 'asignaturas']) }}">
                                <button class="btn_blue">
