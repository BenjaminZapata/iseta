    ...
    <div class="edit-form-container">
            ...
            <div class="perfil_one br">
                ...
                <div class="matricular">
                    ...
                    <form method="post" action="{{route('correlativa.agregar', ['asignatura' => $asignatura->id])}}">
                        ...
                        <div class="upd"><a href=""><button class="btn_blue"><i
                                        class="ti ti-circle-plus"></i>Agregar</button></a></div>
                    </form>
                </div>
            </div>
        @endif
        ...
        <div class="table">
            <div class="perfil__header-alt just-between">
                ...
                <a class="btn_blue" href="/preceptor/cursantes/{{$asignatura->id}}"><i
                ...
                <tbody>
                    ...
                    @foreach ($asignatura->cursadas as $cursada)
                        <tr>
                            ...
                            <td>
                                <a href="{{route('preceptor.cursadas.edit', ['cursada' => $cursada->id])}}"><button
