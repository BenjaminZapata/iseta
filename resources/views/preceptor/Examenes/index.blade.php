...
@section('content')
    ...
    <div>
        ...
        <a href="{{route('preceptor.examenes.create')}}"><button>Inscribir alumno</button></a>

        <div>
            <form action="{{route('preceptor.examenes.index')}}">
                <p>filtrar</p>
                <select name="campo">
            ...
            <a href="{{route('preceptor.examenes.index')}}"><button>Quitar filtro</button></a>
            ...
            <tbody>
                @foreach ($examenes as $examen)
                    <tr>
                        ...
                        <td>{{$examen->nota}}</td>
                        <td><a href="{{route('preceptor.examenes.edit', ['examen' => $examen->id])}}"><button
