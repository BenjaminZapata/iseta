    ...
    <div>
        <div class="perfil_one br">
            ...
            <div class="perfil__info">
                ...
                @if ($anterior)
                    <div><a
                            href="{{route('preceptor.mesas.dual', ['carrera' => $carrera->id, 'asignatura' => $anterior->id])}}">Anterior:
                            {{$anterior->nombre}}</a></div>
                @endif
                @if ($siguiente)
                    <div><a
                            href="{{route('precpetor.mesas.dual', ['carrera' => $carrera->id, 'asignatura' => $siguiente->id])}}">Siguiente:
