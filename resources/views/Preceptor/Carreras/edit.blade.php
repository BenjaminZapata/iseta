    ...
    <div class="edit-form-container">
        <div class="perfil_one br">
            ...
            <div class="perfil__info">
                <?= $form->generate(
        route('preceptor.carreras.update', ['carrera' => $carrera->id]),
        'put',
        [
            'Información' => [
                $form->text(
                ...
                <td class="center">
                    @if($carrera->vigente)
                        <form id="form-desactivar-{{ $carrera->id }}"
                            action="{{ route('preceptor.carreras.desactivar', $carrera) }}" method="POST">
                            @csrf
                ...
                <tbody>
                    @foreach ($carrera->asignaturas as $asignatura)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('preceptor.mesas.create') }}">
                            ...
                            <td>
                                <a
                                    href="{{ route('preceptor.mesas.dual', ['carrera' => $carrera->id, 'asignatura' => $asignatura->id]) }}">
