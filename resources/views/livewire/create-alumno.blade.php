    ...
    <form wire:submit="siguientePaso" x-show="step === 1">
            ...
            <fieldset class="p-2">
                ...
                <div class="grid-2 gap-2 p-0">
                    <label class="label-input-y-75">Nombre:
                        ...
                        <div class="campo-alert">@error('form.nombre') {{ $message }} @enderror</div>
                    </label>
                    <label class="label-input-y-75">Apellido:
                        ...
                        <div class="campo-alert">@error('form.apellido') {{ $message }} @enderror</div>
                    </label>
                    <label class="label-input-y-75">DNI:
                        <input type="text" wire:model="form.dni">
                        <div class="campo-alert">@error('form.dni') {{ $message }} @enderror</div>
                    </label>
                    <label class="label-input-y-75">Fecha de nacimiento:
                        ...
                        <div class="campo-alert">@error('form.fecha_nacimiento') {{ $message }} @enderror</div>
                    </label>
                    <label class="label-input-y-75">Lugar de nacimiento:
                        ...
                        <div class="campo-alert">@error('form.lugar_nacimiento') {{ $message }} @enderror</div>
                    </label>
                    <label class="label-input-y-75">Estado civil:
                        ...
                        <div class="campo-alert">@error('form.estado_civil') {{ $message }} @enderror</div>
                    </label>
                    <label class="label-input-y-75">Género:
                        <select wire:model="form.genero"
                            class="@error('form.genero') border-red-500 @enderror">
                            <option value="">Vacio</option>
            ...
            <fieldset class="p-2">
                ...
                <div class="grid-2 gap-2 p-0">
                    ...
                    <label class="label-input-y-75">Piso:
                        <input type="text" wire:model="piso"
        ...
        <div class="botones-derecha">
            <button type="submit" class="btn_blue">
                Siguiente: Carreras<i class="ti ti-chevron-right" style="font-size: 1.3em; margin-left: 8px;"></i></button>
        </div>
        ...
        <div x-data="{show: $wire.entangle('show').live}" x-cloak>
            ...
            <fieldset class="p-2">
                ...
                <ul class="carreras-list">
                    ...
                    <li>
                        {{ $c['carrera_nombre'] }}
                        <button class="btn_red_outline" type="button" wire:click="eliminarCarrera({{ $c['id_carrera'] }})">Eliminar</button>
                    </li>
                    @endforeach
                </ul>
            </fieldset>
            ...
            <div x-show="show">
                <form wire:submit="guardarInscripcion" class="p-3 border rounded bg-gray-50">
                    ...
                    <label class="block mb-2">
                        ...
                        @error('iForm.anio_inscripcion') <div class="campo-alert">{{ $message }}</div> @enderror
                    </label>

                    <label class="block mb-2">
                        Índice libro matriz:
                        <input type="text" wire:model="iForm.indice_libro_matriz" class="input">
                        @error('iForm.indice_libro_matriz') <div class="campo-alert">{{ $message }}</div> @enderror
                    </label>

                    <label class="block mb-2">
                        Año de finalización:
                        <input type="number" wire:model="iForm.anio_finalizacion" class="input">
                        @error('iForm.anio_finalizacion') <div class="campo-alert">{{ $message }}</div> @enderror
                    </label>

                    <div class="mt-3 flex gap-2">
                        <button type="button" wire:click="$set('show', false)" class="btn_cancelar">Cancelar</button>
