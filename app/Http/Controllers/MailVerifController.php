...
class MailVerifController extends Controller
{
    ...
    public function enviarMail()
    {
        ...
        try {
            ...
            return redirect()->route('token.ingreso')->with('error', 'No se pudo enviar el correo');
        }
     ...
     */
    public function ingresarTokenView()
    {
    ...
    public function enviarMailProfe()
    {
        $token = rand(100000, 999999);
     ...
     * tambien incluye un boton para enviar el mail cuantas veces sea necesario
     */
    public function ingresarTokenViewProfe()
    {
     ...
     * si lo es verifica su cuenta
     */
    public function verificarTokenProfe(Request $request)
    {
