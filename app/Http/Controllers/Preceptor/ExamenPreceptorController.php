...
class ExamenPreceptorController extends Controller
{
 ...
 {
  return view('preceptor.Examenes.edit', compact('examen'));
 }
 ...
 public function destroy(Examen $examen)
 {
  ...
  if (!$mesa)
   return redirect()->route('preceptor.mesas.edit', ['mesa' => $mesa->id])->with('mensaje', 'Se ha eliminado el examen');
  else
   return redirect()->route('preceptor.mesas.index')->with('mensaje', 'Se ha eliminado el examen');
 }
